...
class NagiosServicegroupConfig(NagiosConfig):
    directives_list = [
        { "name": "servicegroup_name", "description": "서비스 그룹 이름 (필수)", "default": None, "is_necessary": True, "is_advanced": False, "option_kind": 0 },
        { "name": "alias", "description": "별명 (필수)", "default": None, "is_necessary": True, "is_advanced": False, "option_kind": 0 },
        { "name": "members", "description": "서비스 이름", "default": None, "is_necessary": False, "is_advanced": False, "option_kind": 3 },
        { "name": "servicegroup_members", "description": "다른 서비스 그룹", "default": None, "is_necessary": False, "is_advanced": False, "option_kind": 4 },
        { "name": "notes", "description": "노트", "default": None, "is_necessary": False, "is_advanced": False, "option_kind": 0 },
        { "name": "notes_url", "description": "", "default": None, "is_necessary": False, "is_advanced": False, "option_kind": 0 },
        { "name": "action_url", "description": "", "default": None, "is_necessary": False, "is_advanced": False, "option_kind": 0 },
    ]
    ...
    def read(self, filename):
        ...
        try:
            ...
            pass
        # 읽어온다
        for directive in NagiosServicegroupConfig.directives_list:
            key = directive['name']
            if key in read_config.keys():
                self.config[key] = read_config[key]
            else:
...
'''
    ...
    def gen_filename(self):
        return self.config['servicegroup_name'] + '.cfg'
