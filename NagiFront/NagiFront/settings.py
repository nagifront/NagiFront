"""
Django settings for NagiFront project.
...
SECRET_KEY = 't87kas1pfggnjcq@^lp1#ep^!nk8am@7ise0mctf%lmyx@s+4%'
...
WSGI_APPLICATION = 'NagiFront.wsgi.application'
